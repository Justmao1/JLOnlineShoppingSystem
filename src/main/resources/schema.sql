...
INSERT INTO PRODUCTS (PRODUCT_ID, CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK_QUANTITY, TYPE, WEIGHT, DOWNLOAD_LINK, IMAGE_PATH) VALUES (1, 2, 'Java Programming Book', 'Comprehensive guide to Java 21', 59.99, 110, 'PHYSICAL', 1.50, NULL, 'images/1764838175752_CleanShot 2025-12-04 at 10.34.12@2x.png');
INSERT INTO PRODUCTS (PRODUCT_ID, CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK_QUANTITY, TYPE, WEIGHT, DOWNLOAD_LINK, IMAGE_PATH) VALUES (2, 1, 'Mechanical Keyboard', 'Clicky keys for coding', 120.50, 2, 'PHYSICAL', 0.80, NULL, NULL);
INSERT INTO PRODUCTS (PRODUCT_ID, CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK_QUANTITY, TYPE, WEIGHT, DOWNLOAD_LINK, IMAGE_PATH) VALUES (3, 1, 'IntelliJ IDEA License', '1-year subscription', 149.00, 984, 'DIGITAL', NULL, 'https://jetbrains.com/download', 'images/1764814219318_CleanShot 2025-12-04 at 10.09.41@2x.png');
INSERT INTO PRODUCTS (PRODUCT_ID, CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK_QUANTITY, TYPE, WEIGHT, DOWNLOAD_LINK, IMAGE_PATH) VALUES (4, 2, 'Design Patterns E-Book', 'PDF version of GoF book', 29.99, 989, 'DIGITAL', NULL, 'https://ebooks.com/gof.pdf', NULL);
INSERT INTO PRODUCTS (PRODUCT_ID, CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK_QUANTITY, TYPE, WEIGHT, DOWNLOAD_LINK, IMAGE_PATH) VALUES (5, NULL, 'phonehorse', '', 666.00, 212, 'PHYSICAL', 11.00, NULL, 'images/1764741696924_phone.png');
...
ALTER TABLE CATEGORIES ALTER COLUMN CATEGORY_ID RESTART WITH 4;
